    ...
    public class SqlConnector : IDataConnection
    {
        ...
        public void CreatePerson(PersonModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(Db)))
            {
                ...
                connection.Execute("dbo.spTestPerson_Insert", p, commandType: CommandType.StoredProcedure);
        ...
        public List<PersonModel> GetPerson_All()
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(Db)))
            {
                output = connection.Query<PersonModel>("dbo.spTestPerson_GetAll").ToList();
            }
            return output;
        }
        ...
        public List<TournamentModel> GetTournament_All()
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(Db)))
            {
                ...
                foreach (TournamentModel tm in output)
                {
                    ...
                    p = new DynamicParameters();
                    p.Add("@TournamentId", tm.Id);
                    tm.EnteredTeams = connection.Query<TeamModel>("dbo.spTeams_GetByTournamentId", p , commandType: CommandType.StoredProcedure).ToList();
